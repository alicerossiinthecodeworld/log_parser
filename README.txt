Парсер для стандартизированных логов, способен проанализировать логи из целой директории или конкретного файла,
...
в случае выбора директории, обрабатывает поочередно каждый файл с расширением .log и формируется общий файл с анализом
в result_json и в консоль выводятся следующие данные :
